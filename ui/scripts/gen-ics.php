...
// Variables used in this script:\
   $location = em_get_location(get_post_meta($pid, '_location_id', true));
   $summary = get_the_title($pid);
   $datestart = str_replace('-','',get_post_meta($pid, '_event_start_date', true))."T".str_replace(':','',get_post_meta($pid, '_event_start_time', true));
   $dateend = str_replace('-','',get_post_meta($pid, '_event_end_date', true))."T".str_replace(':','',get_post_meta($pid, '_event_end_time', true));
   $address = $location->location_name;
   $uri = '';
   $description = '';
   $filename = 'event-'.get_the_title($pid);
//
// Notes:
