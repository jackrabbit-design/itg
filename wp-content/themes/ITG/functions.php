...
add_image_size( 'team', 540, 300, true);
add_image_size( 'promo', 730, 217, true);
add_image_size( 'landing', 360, 360, true);
add_image_size( 'team-thumb', 105, 60, true);
add_image_size( 'page-banner', 1800, 310, true);
...
function the_slug($echo=true,$id){
    if($id == ''){
        $id = $post->ID;
    }
